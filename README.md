  <h1>Operational tools for Identifying Subpopulations and Evolutionary Significant Units to Support Conservation Management</em></h1>
  ...
  <h2 id="Overview of the testing process">Overview of the testing process</h2>
   <p>Overview of the testing process/framework (Figure 1B)</p>
  <ol>
    <li>Species are assessed in so-called ‘candidate scenarios’.</li>
    <li>Within the framework three different lines of evidence (“genetic evidence”, “recorded-biological evidence” and “inferred evidence”) are used to accommodate different data availabilities for species (Figure 1A).</li>
    <li>Four different scenarios can be assessed simultaneously</li>
     <li>In Phase 1, genetically meaningful subpopulations are identified (Figure 1B).</li>
    <li>Candidate scenarios scoring ≥2 points qualify for Phase 2.</li>
        <li>In Phase 2, the subpopulations identified in Phase 1 may be tested individually or grouped into candidate ESU scenarios (Figure 1B). As with Phase 1, different lines of evidence are used to assess their ESU status.</li>
  </ol>
